  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success && data.admin) {
        ...
        // Store admin data
        localStorage.setItem('bharatfunded-admin-token', 'admin-' + data.admin._id);
        localStorage.setItem('bharatfunded-admin-user', JSON.stringify(data.admin));
        localStorage.setItem('bharatfunded-admin', JSON.stringify(data.admin));
