            ...
            <div className="terms-modal">
              ...
              <div className="terms-modal-body" ref={termsRef} onScroll={handleTermsScroll}>
                ...
                <section className="terms-section">
                  ...
                  <p>Bharath Funded Trader provides <strong>technical support and platform services only</strong>. We do not provide investment advice, guaranteed returns, or trading signals. All trading decisions are made solely by you.</p>
                </section>
                <section className="terms-section">
                ...
                <section className="terms-section disclaimer-section">
                  ...
                  <p>By registering on Bharath Funded Trader, you confirm that you have read, understood, and agree to all the terms and conditions stated above.</p>
