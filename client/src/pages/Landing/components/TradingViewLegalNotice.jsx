      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            Advanced charts, Stock Heatmap, and related market widgets on BharatFundedTrade are{' '}
            <strong>provided by TradingView</strong> and are subject to TradingView&apos;s terms,
            policies, and technical requirements. TradingView is a third-party service; BharatFundedTrade is
