...
const markets = [
  {
    icon: TrendingUp,
    title: 'NSE Equities',
    desc: 'Trade India\'s top listed companies on the National Stock Exchange with live prices.',
    tag: 'RELIANCE · TCS · INFY',
    stats: [{ label: 'Instruments', value: '2,000+' }, { label: 'Avg Spread', value: '0.05%' }],
  },
  {
    icon: Landmark,
    title: 'BSE Equities',
    desc: 'Access Bombay Stock Exchange stocks and Sensex constituents seamlessly.',
    tag: 'SENSEX 30 · Mid Cap · Small Cap',
    stats: [{ label: 'Instruments', value: '5,000+' }, { label: 'Coverage', value: 'Full BSE' }],
  },
  {
    icon: BarChart2,
    title: 'Indian Indices',
    desc: 'Trade NIFTY50, BANKNIFTY, FINNIFTY, and SENSEX index products.',
    tag: 'NIFTY50 · BANKNIFTY · FINNIFTY',
    stats: [{ label: 'Indices', value: '4' }, { label: 'Leverage', value: '1:100' }],
  },
  {
    icon: IndianRupee,
    title: 'INR-Native Platform',
    desc: 'Deposit, trade and withdraw everything in Indian Rupees — no FX conversion needed.',
    tag: '₹ INR Only',
    stats: [{ label: 'Currency', value: '₹ INR' }, { label: 'Settlement', value: 'Instant' }],
  },
];
