...
const SOCKET_KEY = '__bharatfunded_socket__';
const CACHE_KEY = '__bharatfunded_price_cache__';
const LISTENERS_KEY = '__bharatfunded_listeners__';
...
class SocketService {
  ...
  init() {
    ...
    if (!this.socket._bharatfundedCoreListenersAttached) {
      this.socket._bharatfundedCoreListenersAttached = true;
