...
const adminAccounts = [
  {
    oderId: 'ADMIN001',
    email: process.env.ADMIN_EMAIL || 'admin@bharatfundedtrade.com',
    phone: '9999999999',
    password: process.env.ADMIN_DEFAULT_PASSWORD || 'Admin@BharatFunded2024',
    name: 'Super Admin',
    role: 'admin',
    wallet: {
      balance: 1000000,
  ...
  {
    oderId: 'SUBADMIN001',
    email: 'subadmin@bharatfundedtrade.com',
    phone: '9999999998',
  ...
  {
    oderId: 'BROKER001',
    email: 'broker@bharatfundedtrade.com',
    phone: '9999999997',
    password: 'Broker@123',
    name: 'Broker',
    role: 'broker',
